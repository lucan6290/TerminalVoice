    ...
    <div className="fixed top-4 left-1/2 -translate-x-1/2 z-[100] flex flex-col items-center gap-2 pointer-events-none">
      {toasts.map((t) => {
        ...
        return (
          <div
            key={t.id}
            className="pointer-events-auto animate-fade-in flex items-center gap-2 px-4 py-2.5 rounded-xl bg-neutral-800/95 backdrop-blur-md shadow-xl ring-1 ring-white/10 text-[13px] text-neutral-100 max-w-[320px]"
          >
