    ...
    >
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[11px] font-medium text-teal-400">翻译结果</span>
        </div>
        <button
          type="button"
          aria-label="关闭翻译"
      ...
      <div className="space-y-2">
        <div>
          <p className="text-[10px] text-neutral-500 mb-0.5">原文</p>
        ...
        <div>
          <p className="text-[10px] text-teal-400/70 mb-0.5">译文</p>
