...
const zh: Record<string, string> = {
  ...
  "tab.help.feedback.githubPath": "在 GitHub 提交 Issue",
  "tab.help.feedback.emailPath": "发送邮件反馈",
  "tab.help.openFailEmail": "打开邮箱失败",
...
const en: Record<string, string> = {
  ...
  "tab.help.feedback.githubPath": "Open an issue on GitHub",
  "tab.help.feedback.emailPath": "Send feedback by email",
  "tab.help.openFailEmail": "Failed to open email",
