...
const zh: Record<string, string> = {
  ...
  "tab.help.link.website": "官方网站",
  "tab.help.thanksFeedback": "感谢反馈！",
  "tab.help.openFailGithub": "打开 GitHub 失败",
  "tab.help.openFailWebsite": "打开官网失败",
  "tab.help.feedback.title": "问题反馈",
  "tab.help.feedback.close": "关闭",
  "tab.help.feedback.type": "问题类型",
  "tab.help.feedback.type.bug": "Bug",
  "tab.help.feedback.type.feature": "功能建议",
  "tab.help.feedback.type.experience": "体验问题",
  "tab.help.feedback.type.other": "其他",
  "tab.help.feedback.issueTitle": "问题标题",
  "tab.help.feedback.issueTitlePlaceholder": "用一句话描述问题",
  "tab.help.feedback.description": "详细描述",
  "tab.help.feedback.descriptionPlaceholder": "请描述发生了什么、期望结果、复现步骤或截图线索。",
  "tab.help.feedback.contact": "联系方式",
  "tab.help.feedback.contactPlaceholder": "邮箱 / GitHub / 微信（可选）",
  "tab.help.feedback.submit": "反馈",
  "tab.help.feedback.submitting": "提交中...",
  "tab.help.feedback.validationTitle": "标题至少 3 个字符，最多 120 个字符",
  "tab.help.feedback.validationDescription": "详细描述至少 10 个字符，最多 5000 个字符",
  "tab.help.feedback.validationUnsafe": "内容包含不允许的脚本或链接格式",
  "tab.help.feedback.success": "反馈已提交，感谢你的帮助。",
  "tab.help.feedback.queued": "网络暂不可用，反馈已缓存，将在网络恢复后自动重试。",
  "tab.help.feedback.failed": "反馈提交失败",
  ...
  "tab.service.feedback.section": "反馈通道",
  "tab.service.feedback.githubEnabled": "GitHub Issue",
  "tab.service.feedback.emailEnabled": "邮件同步",
  "tab.service.feedback.githubToken": "GitHub Token",
  "tab.service.feedback.emailEndpoint": "邮件 API URL",
  "tab.service.feedback.emailRecipient": "收件邮箱",
  "tab.service.feedback.hint": "反馈默认提交到 lucan6290/TerminalVoice。GitHub Token 使用 DPAPI 加密存储；邮件通道接收 JSON POST。",
...
const en: Record<string, string> = {
  ...
  "tab.help.link.website": "Website",
  "tab.help.thanksFeedback": "Thanks for your feedback!",
  "tab.help.openFailGithub": "Failed to open GitHub",
  "tab.help.openFailWebsite": "Failed to open website",
  "tab.help.feedback.title": "Feedback",
  "tab.help.feedback.close": "Close",
  "tab.help.feedback.type": "Issue type",
  "tab.help.feedback.type.bug": "Bug",
  "tab.help.feedback.type.feature": "Feature request",
  "tab.help.feedback.type.experience": "Experience issue",
  "tab.help.feedback.type.other": "Other",
  "tab.help.feedback.issueTitle": "Issue title",
  "tab.help.feedback.issueTitlePlaceholder": "Describe the issue in one sentence",
  "tab.help.feedback.description": "Description",
  "tab.help.feedback.descriptionPlaceholder": "Describe what happened, expected behavior, reproduction steps, or screenshot clues.",
  "tab.help.feedback.contact": "Contact",
  "tab.help.feedback.contactPlaceholder": "Email / GitHub / WeChat (optional)",
  "tab.help.feedback.submit": "Send Feedback",
  "tab.help.feedback.submitting": "Submitting...",
  "tab.help.feedback.validationTitle": "Title must be 3-120 characters",
  "tab.help.feedback.validationDescription": "Description must be 10-5000 characters",
  "tab.help.feedback.validationUnsafe": "Content contains disallowed script or link patterns",
  "tab.help.feedback.success": "Feedback submitted. Thanks for helping improve TerminalVoice.",
  "tab.help.feedback.queued": "Network is unavailable. Feedback was cached and will retry automatically.",
  "tab.help.feedback.failed": "Failed to submit feedback",
  ...
  "tab.service.feedback.section": "Feedback channels",
  "tab.service.feedback.githubEnabled": "GitHub Issue",
  "tab.service.feedback.emailEnabled": "Email sync",
  "tab.service.feedback.githubToken": "GitHub Token",
  "tab.service.feedback.emailEndpoint": "Email API URL",
  "tab.service.feedback.emailRecipient": "Recipient email",
  "tab.service.feedback.hint": "Feedback is submitted to lucan6290/TerminalVoice by default. GitHub Token is encrypted with DPAPI; email channel receives a JSON POST.",
