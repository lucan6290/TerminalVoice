...
| [panel/](panel/) | `panel` | `#/panel` | 380×612 | 透明、无边框、置顶、任务栏隐藏 |
...
4. 透明窗口组件根部要 `background: "transparent"`，由父级 `.window-transparent` body/#root class 配合；透明窗口可见卡片外不要留 padding 或外扩阴影，避免 WebView2 透明区出现灰色矩形底。
